...
*/
if( yummy_bites_is_elementor_activated() ){
...
/**
 * Random Recipe Redirect Functionality
 */
require get_template_directory() . '/inc/random-recipe.php';

/**
 * Widgets
 */
require get_template_directory() . '/inc/popular-recipes.php';
